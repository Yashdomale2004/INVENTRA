  ...
  return (
    <div className="space-y-4">
      ...
      <section className="relative space-y-6">
        ...
        <Card className="relative border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900 sm:p-5">
          <div className="flex items-start gap-4">
            <div className="mt-1 h-3 w-3 rounded-full bg-blue-600 sm:h-3.5 sm:w-3.5" />
            <div>
              <h2 className="text-base font-bold text-slate-900 dark:text-slate-100 sm:text-lg">Stock Up</h2>
              <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">Add new stock received from distributors.</p>
              <div className="mt-4">
                <Link to="/stock-up" className="inline-flex items-center gap-1.5 rounded-xl bg-slate-100 px-3 py-1.5 text-xs font-semibold text-slate-900 transition hover:bg-slate-200 dark:bg-slate-800 dark:text-slate-100 dark:hover:bg-slate-700 sm:gap-2 sm:rounded-2xl sm:px-4 sm:py-2 sm:text-sm">
                  <Box className="h-3.5 w-3.5 sm:h-4 sm:w-4" /> Open Stock Up
                </Link>
              </div>
            </div>
          </div>
        ...
        <Card className="relative border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900 sm:p-5">
          <div className="flex items-start gap-4">
            <div className="mt-1 h-3 w-3 rounded-full bg-blue-600 sm:h-3.5 sm:w-3.5" />
            <div>
              <h2 className="text-base font-bold text-slate-900 dark:text-slate-100 sm:text-lg">Enquiry</h2>
              <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">Capture and manage customer inventory assignments.</p>
              <div className="mt-4">
                <button
                  type="button"
                  onClick={() => navigate("/enquiry")}
                  className="inline-flex items-center gap-1.5 rounded-xl bg-slate-100 px-3 py-1.5 text-xs font-semibold text-slate-900 transition hover:bg-slate-200 dark:bg-slate-800 dark:text-slate-100 dark:hover:bg-slate-700 sm:gap-2 sm:rounded-2xl sm:px-4 sm:py-2 sm:text-sm"
                >
                  <Search className="h-3.5 w-3.5 sm:h-4 sm:w-4" /> Open Enquiry
                </button>
              </div>
            </div>
          </div>
        ...
        <Card className="relative border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900 sm:p-5">
          ...
          >
            <div className="mt-1 h-3 w-3 shrink-0 rounded-full bg-blue-600 sm:h-3.5 sm:w-3.5" />
            <div className="w-full min-w-0">
              <div className="flex items-center justify-between gap-3">
                <h2 className="text-base font-bold text-slate-900 dark:text-slate-100 sm:text-lg">Order Summary</h2>
        ...
        <Card className="relative border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900 sm:p-5">
          <div className="flex flex-col gap-4">
            <div className="flex items-start gap-4">
              ...
              >
                <h2 className="text-base font-bold text-slate-900 dark:text-slate-100 sm:text-lg">Order History</h2>
        ...
        <Card className="relative border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900 sm:p-5">
          <div className="flex items-start gap-4">
            <div className="mt-1 h-3 w-3 rounded-full bg-blue-600 sm:h-3.5 sm:w-3.5" />
            <div>
              <h2 className="text-base font-bold text-slate-900 dark:text-slate-100 sm:text-lg">Track</h2>
              <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">Open tracking instantly for parcel updates.</p>
              <div className="mt-4">
                <Link to="/track" className="inline-flex items-center gap-1.5 rounded-xl bg-slate-100 px-3 py-1.5 text-xs font-semibold text-slate-900 transition hover:bg-slate-200 dark:bg-slate-800 dark:text-slate-100 dark:hover:bg-slate-700 sm:gap-2 sm:rounded-2xl sm:px-4 sm:py-2 sm:text-sm">
                  <Truck className="h-3.5 w-3.5 sm:h-4 sm:w-4" /> Open Tracking
                </Link>
              </div>
            </div>
          </div>
        ...
        <Card className="relative border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900 sm:p-5">
          <div className="flex flex-col gap-4">
            <div className="flex items-start gap-4">
              ...
              >
                <div>
                  <h2 className="text-base font-bold text-slate-900 dark:text-slate-100 sm:text-lg">Delivered Orders</h2>
